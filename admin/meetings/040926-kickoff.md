...
1.  Discuss Management Assignments
2.  Branding and Video
3.  Rules/Contract
4.  Roles
...
*   **Item 1:** Group Name
    *   *Discussion:* Decided our name will be SWEaters United.
    *   *Status:* Resolved
...
*   **Topic 1:** Group Contract (Goals and Values)
    *   *Discussion:*
...
*   **Topic 2:** Group Contract (Strengths, Weaknesses, and Role Discussion)
    *   *Discussion:* We began talking about our strengths and weaknesses individually.
        * Strengths
          * Python, React.js, JavaScript, Markdown, HTML, CSS, C++, and some Video Editing (Final Cut/ iMovie). These are are strengths across all members.
        * Weaknesses
...
*   **Topic 3:** Group Contract (Rules and Expectations)
    *   *Discussion:* We began discussing some rules and expectations of our team.
        ...
        * We also highlighted situations in which effort seems to not be evenly distributed and said that communication was key in these moments.
...
*   **Topic 5:** Branding
    *   *Discussion:* We began discussing the Branding Assignment and started assigning roles to complete it
          ...
          * We highlighted that Brand Team should promptly get to work since other teams rely on them.
---
...
* Branding assignment roles
   ...
   * Page: Scott, Sophia, Gurnoor, Abdurrahman
   * Video: Mani, Paul, Justine, Andrew
* Group Bonding event this weekend
